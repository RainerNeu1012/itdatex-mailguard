 ...
 * Description:       Multi-Tenant Phishing-/Spam-/Newsletter-Schutz fuer die Endkunden des Site-Owners. Endkunden registrieren sich im Portal, binden ihre IMAP-Konten ein, eingehende Mails werden automatisch gegen die antiphish-API gescannt.
 * Version:           0.1.0
...
define( 'ITDATEX_MAILGUARD_VERSION', '0.1.0' );
